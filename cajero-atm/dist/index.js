...
const CajeroService_1 = require("./application/CajeroService");
const RepositorioCuentas_1 = require("./infrastructure/RepositorioCuentas");
...
// ===== SETUP =====
const repositorio = new RepositorioCuentas_1.RepositorioCuentas();
const cajero = new CajeroService_1.CajeroService();
const cuentaInicial = {
    numeroCuenta: "0012345678",
    saldo: new Dinero_1.Dinero(500),
    pin: "1234",
    activa: true,
};
...
const dinero1 = new Dinero_1.Dinero(100);
...
const dinero3 = dinero2.sumar(new Dinero_1.Dinero(50)); // esto crea un objeto NUEVO
